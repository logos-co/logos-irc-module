# Builds the logos-irc-module library
...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    if [ -f modules/logos_irc_plugin.dylib ]; then
      cp modules/logos_irc_plugin.dylib $out/lib/
    elif [ -f modules/logos_irc_plugin.so ]; then
      cp modules/logos_irc_plugin.so $out/lib/
    else
